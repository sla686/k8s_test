...
kubectl set image deployments/client-deployment client=sla686/client-server:$SHA
kubectl set image deployments/worker-deployment worker=sla686/worker-server:$SHA